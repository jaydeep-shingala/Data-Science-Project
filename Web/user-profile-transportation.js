...
firebase.auth().onAuthStateChanged(function(user) {
  ...
  if (user) {
	...
	var userRef = firebase.database().ref().child('/transportation/' + 'user');
	...
	var ref2 = firebase.database().ref().child('/transportation/' + userId);
	var c=0;
...
{
	var MassageRef = firebase.database().ref('transportation/'+ 'user');
//	window.alert(f);
